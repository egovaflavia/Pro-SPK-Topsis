    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <br><br>
                    <h1 align=center style="font-family:Tahoma;" class="m-0 text-dark"> <strong>HASIL <br> Tahun Ajaran <?= $_POST['tahun'] ?></strong> </h1>
                </div><!-- /.col -->
                <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href="cetak.php?tahun=<?= $_POST['tahun'] ?>" target="_blank" class="btn btn-success mb-3 mt-3">Cetak</a>
                        <?php
                        $bobot = [];
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                $alternative_nama = [];
                                foreach ($db->getRatingByTahun($_POST['tahun']) as $noKec => $dataRating) :
                        ...
                        <?php
                        foreach ($db->getRatingByTahun($_POST['tahun']) as $noo => $dataRating) :
                        ?>
                        <?php endforeach ?>
                        <?php
                        $xx1 = null;
                        ...
                        $xx5 = null;
                        $xx6 = null;
                        foreach ($db->getRatingByTahun($_POST['tahun']) as $nooo => $dataRating) :
